...
def detector(img,current_state):
    try:
        fps = 0.0
        count = 0
        ...
        while True:
            ...
            for x in range(len(class_present)):
                ...
                if class_score[x] > 0.6:
                    ...
                    if class_present[x] == 0 and "gun" not in current_state:
                        print("Handgun")
                        current_state=["gun"]
                        msg="Alert! Gun Detected"
                        print(msg)
                    ...
                    if class_present[x] == 1 and "knife" not in current_state:                
                        print("knife")
                        current_state=["knife"]
                        msg = "Alert! Knife Detetcted."
                        print(msg)
                        doc_ref.set({
                        'currDate': currDate,
                        'currTime': currTime,
            ...
            return ("object detection successful",current_state)                  
